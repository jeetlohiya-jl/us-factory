...
export default function MaterialConsumptionWizard({
  ...
  const canFinalize = primaryCount > 0 && !!detail.machine_id && !!detail.shift && !!detail.start_time;
      ...
      <div className="side-panel open">
        ...
        <div className="sp-body">
          ...
          <div className="form-grid" style={{ marginBottom: 24 }}>
            ...
            <div className="field">
              ...
              <input type="time" disabled={!canEdit} value={detail.start_time || ""} onChange={(e) => patchBasic({ start_time: e.target.value })} />
            </div>
            <div className="field">
              <label>End Time</label>
              <input type="time" disabled={!canEdit} value={detail.end_time || ""} onChange={(e) => patchBasic({ end_time: e.target.value })} />
            </div>
          </div>
        ...
        <div className="sp-foot">
          ...
          <div className="sp-foot-right">
            ...
            {canEdit && <button className="btn btn-primary" disabled={busy || !canFinalize} onClick={handleFinalSave}>Save</button>}
          </div>
        </div>
      </div>
    </>
